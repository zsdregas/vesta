...
$LANG['el'] = array(
    ...
    'Template'  => 'Πρότυπο',
    'Web Template'  => 'Πρότυπο ιστοσελίδων',
    'Backend Template'  => 'Πρότυπο Διαχείρισης',
    'Proxy Template' =>'Πρότυπο Proxy',
    'DNS Template'  => 'Πρότυπο DNS',
    'Web Domains'  => 'Πρότυπο Web Domains',
    'SSL Domains'  => 'Πρότυπο SSL Domains',
    ...
    'Default Name Servers'  => 'Προεπιλεγμένοι Εξυπηρετητές Ονόματος',
    'Domain'  => 'Domain',
    ...
    'Add one more Name Server' => 'Προσθήκη ενός ακόμα Εξυπηρετητή Ονομάτων',
    ...
    'LEAVE_PAGE_CONFIRMATION' => 'Να φύγετε από τη σελίδα;',
    ...
    'RESET_NOTICE'  => 'Ειδοποίηση Επαναφοράς',
    ...
    'Configuring Server' => 'Ρύθμιση Εξυπηρετητή',
    'Hostname' => 'Hostname',
    'Time Zone' => 'Ζώνη ώρας',
    'Default Language' => 'Προκαθορισμένη Γλώσσα',
    'FileSystem Disk Quota' => 'Όριο Συστήματος Αρχείων Δίσκου',
    'Vesta Control Panel Plugins' => 'Πρόσθετα Πίνακα Ελέγχου Vesta',
    'preview' => 'προεπισκόπηση',
    'Reseller Role' => 'Ρόλος Μεταπωλητή',
    'Web Config Editor' => 'Διορθωτής Ρυθμίσεων Web',
    'Template Manager' => 'Διαχειριστής Προτύπων',
    'Backup Migration Manager' => 'Διαχειριστής Αντιγράφων Ασφαλείας',
    'FileManager' => 'Διαχειριστής Αρχείων',
    'show: CPU / MEM / NET / DISK' => 'εμφάνιση: ΚΜΕ / ΜΝΗΜΗ / ΔΙΚΤΥΟ / ΔΙΣΚΟΣ',

    'sort by' => 'ταξινομημένο κατά',
    'Date' => 'Ημερομηνία',
    'Starred' => 'Με αστέρι',
    'Name' => 'Όνομα',
    ...
    'DOWNLOAD' => 'ΛΗΨΗ',
    'Hit' => 'Πάτα',
    'to reload the page' => 'για να ξαναφορτώσει η σελίδα',
    'Directory name cannot be empty' => 'Το όνομα του φακέλου δεν μπορεί να είναι κενό',
    'File name cannot be empty' => 'Το όνομα του αρχείου δεν μπορεί να είναι κενό',
    'No file selected' => 'Δεν επιλέχθηκε κανένα αρχείο',
    'No file or folder selected' => 'Δεν επιλέχθηκε κανένα αρχείο ή φάκελος',
    'File type not supported' => 'Ο τύπος αρχείου δεν υποστηρίζεται',
    'Directory download not available in current version' => 'Δεν είναι διαθέσιμο το κατέβασμα φακέλου στην τρέχουσα έκδοση',
    ...
    'Compress' => 'Συμπίεση',
    'OK' => 'ΟΚ',
    'Are you sure you want to copy' => 'Σίγουρα θέλετε να αντιγράψετε',
    'Are you sure you want to delete' => 'Σίγουρα θέλετε να διαγράψετε',
    'into' => 'στο',
    'existing files will be replaced' => 'τα υπάρχοντα αρχεία θα αντικατασταθούν',
    'Original name' => 'Αρχικό όνομα',
    'File' => 'Αρχείο',
    'already exists' => 'υπάρχει ήδη',
    'Create file' => 'Δημιουργία αρχείου',
    'Create directory' => 'Δημιουργία φακέλου',

    'Add New object' => 'Προσθήκη Νέου Αντικειμένου',
    'Save Form' => 'Αποθήκευση Φόρμας',
    'Cancel saving form' => 'Ακύρωση αποθήκευσης φόρμας',
    'Go to USER list' => 'Πήγαινε στη λίστα ΧΡΗΣΤΩΝ',
    'Go to WEB list' => 'Πήγαινε στη λίστα ΙΣΤΟΣΕΛΙΔΩΝ',
    'Go to DNS list' => 'Πήγαινε στη λίστα DNS',
    'Go to MAIL list' => 'Πήγαινε στη λίστα ΗΛΕΚΤΡΟΝΙΚΟΥ ΤΑΧΥΔΡΟΜΕΙΟΥ',
    'Go to DB list' => 'Πήγαινε στη λίστα ΒΑΣΕΩΝ ΔΕΔΟΜΕΝΩΝ',
    'Go to CRON list' => 'Πήγαινε στη λίστα CRON',
    'Go to BACKUP list' => 'Πήγαινε στη λίστα ΑΝΤΙΓΡΑΦΩΝ ΑΣΦΑΛΕΙΑΣ',
    'Focus on search' => 'Εστίαση στην αναζήτηση',
    'Display/Close shortcuts' => 'Προβολή/Κλείσιμο συντομεύσεων',
    'Move backward through top menu' => 'Μετακίνηση πίσω μέσω του μενού στην κορυφή',
    'Move forward through top menu' => 'Μετακίνηση μπροστά μέσω του μενού στην κορυφή',
    'Enter focused element' => 'Πήγαινε στο εστιασμένο πεδίο',
    ...
    'Delete' => 'Διαγραφή',
    'Save File (in text editor)' => 'Αποθήκευση Αρχείου (στο διορθωτή κειμένου)',
    'Close Popup / Cancel' => 'Κλείσιμο Αναδυόμενου Παραθύρου / Ακύρωση',
    'Move Cursor Up' => 'Μετακίνηση Δρομέα Πάνω',
    'Move Cursor Dow' => 'Μετακίνηση Δρομέα Κάτω',
    'Switch to Left Tab' => 'Μετάβαση στην Αριστερή Καρτέλα',
    'Switch to Right Tab' => 'Μετάβαση στη Δεξιά Καρτέλα',
    'Switch Tab' => 'Αλλαγή Καρτέλας',
    'Go to the Top of File List' => 'Μετάβαση στην κορυφή της Λίστας Αρχείων',
    'Go to the Last File' => 'Μετάβαση στο Τελευταίο Αρχείο',
    'Open File/Enter Directory' => 'Άνοιγμα Αρχείου/Εισαγωγή σε Φάκελο',
    'Go to Parent Directory' => 'Μετάβαση στον Πατρικό Φάκελο',
    'Select Current File' => 'Επιλογή Τρέχοντος Αρχείου',
    'Select Bunch of Files' => 'Επιλογή Πολλών Αρχείων',
    'Append File to the Current Selection' => 'Προσθήκη Αρχείου στην Τρέχουσα Επιλογή',
    'Select All Files' => 'Επιλογή Όλων των Αρχείων',
    'shortcuts are inspired by magnificent GNU <a href="https://www.midnight-commander.org/">Midnight Commander</a> file manager' => 
        'οι συντομεύσεις βασίστηκαν στο φανταστικό GNU διαχειριστή αρχείων <a href="https://www.midnight-commander.org/">Midnight Commander</a>',

    'Licence Key' => 'Κλειδί Άδειας Χρήσης',
    'Enter License Key' => 'Εισαγωγή Κλειδιού Άδειας Χρήσης',
    'Buy Licence' => 'Αγορά Άδειας Χρήσης',
    'Buy Lifetime License' => 'Αγορά Εισόβιας Άδειας >Χρήσης',
    'Disable and Cancel Licence' => 'Απενεργοποίηση και Ακύρωση Άδειας',
    'Licence Activated' => 'Η Άδεια Ενεργοποίηθηκε',
    'Licence Deactivated' => 'Η Άδεια Απενεργοποίηθηκε',
    'Restrict users so that they cannot use SSH and access only their home directory.' => 'Περιορισμός χρηστών ώστε να μην μπορούν να SSH και να έχουνε πρόσβαση μόνο στον αρχικό τους φάκελο.',
    'Browse, copy, edit, view, and retrieve all of your web domain files using fully featured File Manager.' => 'Περιήγηση, αντιγραφή, επεξεργασία, προβολή, και ανάκτηση όλων των αρχείων του ιστοχώρου σας χρησιμοποιώντας τον Διαχειριστή Αρχείων.',
    'This is a commercial module, you would need to purchace license key to enable it.' => 'Αυτό είναι ένα εμπορικό άρθρωμα, πρέπει να αγοράσετε κλειδί άδειας χρήσης για να το ενεργοποιήσετε.'
